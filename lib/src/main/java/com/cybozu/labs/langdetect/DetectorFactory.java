...
//                //(new YI()).getLangProfile() // Yiddish
                ...
                new LT().getLangProfile(),
                new LV().getLangProfile(),
                new MK().getLangProfile(),
                new ML().getLangProfile(),
